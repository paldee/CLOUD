...
## 🚀 วิธีการใช้งาน Script สร้างข้อมูล (สำหรับ Developer)
โปรเจคนี้มีสคริปต์ `generate_dataset.py` ที่ใช้สำหรับจำลองข้อมูลใหม่ หากต้องการสร้างข้อมูลใหม่สามารถรันคำสั่ง:

```bash
python generate_dataset.py
```
*ระบบจะทำการสร้างไฟล์ CSV ใหม่ทั้งหมดไว้ในโฟลเดอร์ `/dataset/` พร้อมเช็ค Business Rules อัตโนมัติ*
